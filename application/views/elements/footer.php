        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="payments">
                        <ul>
                            <li><img src="<?= base_url('public/style'); ?>/img/visa.jpg" alt=""/></li>
                            <li><img src="<?= base_url('public/style'); ?>/img/mastercard.jpg" alt=""/></li>
                            <li><img src="<?= base_url('public/style'); ?>/img/paypal.jpg" alt=""/></li>
                            <li><img src="<?= base_url('public/style'); ?>/img/american-express.jpg" alt=""/></li>
                            <li><img src="<?= base_url('public/style'); ?>/img/visa-electron.jpg" alt=""/></li>
                            <li><img src="<?= base_url('public/style'); ?>/img/maestro.jpg" alt=""/></li>
                        </ul>
                    </div>
                </div>
