...
<html lang="en">
    ...
    <body id="home" class="wide">
                    ...
                    <div class="container">
                        <div class="cart-items">
                            <div class="cart-items-inner">
                                <div class="media">
                                    <a class="pull-right" href="#"><img class="media-object item-image" src="<?= base_url('public/style');?>/img/preview/shop/order-1s.jpg" alt=""></a>
                ...
                <div class="container">
                    <div class="top-bar-left">
                        <ul class="list-inline">
                            <li class="icon-user"><a href="login.html"><img src="<?= base_url('public/style');?>/img/icon-1.png" alt=""/> <span>Login</span></a></li>
                            <li class="icon-form"><a href="login.html"><img src="<?= base_url('public/style');?>/img/icon-2.png" alt=""/> <span>Not a Member? <span class="colored">Sign Up</span></span></a></li>
                    ...
                    <div class="top-bar-right">
                        <ul class="list-inline">
                            ...
                            <li class="dropdown flags">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?= base_url('public/style');?>/img/flag.gif" alt=""/> Eng<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="dropdown-menu">
                                    <li><a href="#"><img src="<?= base_url('public/style');?>/img/flag.gif" alt=""/> Eng</a></li>
                                    <li><a href="#"><img src="<?= base_url('public/style');?>/img/flag.gif" alt=""/> Eng</a></li>
                                    <li><a href="#"><img src="<?= base_url('public/style');?>/img/flag.gif" alt=""/> Eng</a></li>
                                </ul>
                            </li>
            ...
            <header class="header fixed">
                <div class="header-wrapper">
                    <div class="container">
                        ...
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.html"><img src="<?= base_url('public/style');?>/img/logo-bella-shop.png" alt="Bella Shop"/></a>
                        </div>
                        <!-- /Logo -->
                                                ...
                                                <div class="product-list">
                                                    <div class="media">
                                                        <a class="pull-right media-link" href="#">
                                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/shop/top-sellers-2.jpg" alt="">
                                                    ...
                                                    <div class="media">
                                                        <a class="pull-right media-link" href="#">
                                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/shop/top-sellers-3.jpg" alt="">
                                                            <i class="fa fa-plus"></i>
                                                        </a>
                                                        <div class="media-body">
                                                            <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                        ...
                        <div class="main-slider">
                            <div class="owl-carousel" id="main-slider">
                                ...
                                <div class="item slide1">
                                    <img class="slide-img" src="<?= base_url('public/style');?>/img/preview/slider/slide-1.jpg" alt=""/>
                                    <div class="caption">
                                        <div class="container">
                                            <div class="div-table">
                                                <div class="div-cell">
                                ...
                                <div class="item slide2 alt">
                                    <img class="slide-img" src="<?= base_url('public/style');?>/img/preview/slider/slide-2.jpg" alt=""/>
                                    <div class="caption">
                                        <div class="container">
                                            <div class="div-table">
                                                <div class="div-cell">
                                ...
                                <div class="item slide3 dark">
                                    <img class="slide-img" src="<?= base_url('public/style');?>/img/preview/slider/slide-3.jpg" alt=""/>
                                    <div class="caption">
                                        <div class="container">
                                            <div class="div-table">
                                                <div class="div-cell">
                        ...
                        <div class="row">
                                ...
                                <div class="thumbnail no-border no-padding thumbnail-banner size-1x3">
                                    <div class="media">
                                        <a class="media-link" href="#">
                                            <div class="img-bg" style="background-image: url('<?= base_url('public/style');?>/img/preview/shop/banner-1.jpg')"></div>
                                            <div class="caption">
                            ...
                            <div class="col-md-6">
                                <div class="thumbnail no-border no-padding thumbnail-banner size-1x3">
                                    <div class="media">
                                        <a class="media-link" href="#">
                                            <div class="img-bg" style="background-image: url('<?= base_url('public/style');?>/img/preview/shop/banner-2.jpg')"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6">
                                        <div class="thumbnail no-border no-padding">
                                            <div class="media">
                                                <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                                    <img src="<?= base_url('public/style');?>/img/preview/shop/product-3.jpg" alt=""/>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="thumbnail no-border no-padding">
                                            <div class="media">
                                                <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                                    <img src="<?= base_url('public/style');?>/img/preview/shop/product-4.jpg" alt=""/>
                                                    <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                                </a>
                                            </div>
                                            <div class="caption text-center">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="thumbnail no-border no-padding">
                                            <div class="media">
                                                <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                                    <img src="<?= base_url('public/style');?>/img/preview/shop/product-1.jpg" alt=""/>
                                                    <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                                </a>
                                            </div>
                                            <div class="caption text-center">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="thumbnail no-border no-padding">
                                            <div class="media">
                                                <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                                    <img src="<?= base_url('public/style');?>/img/preview/shop/product-2.jpg" alt=""/>
                                                    <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                                </a>
                                            </div>
                                            <div class="caption text-center">
                        ...
                        <div class="top-products-carousel">
                            <div class="owl-carousel" id="top-products-carousel">
                                <div class="thumbnail no-border no-padding">
                                    <div class="media">
                                        <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                            <img src="<?= base_url('public/style');?>/img/preview/shop/top-rated-1.jpg" alt=""/>
                                            <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                        </a>
                                    </div>
                                    <div class="caption text-center">
                                ...
                                <div class="thumbnail no-border no-padding">
                                    <div class="media">
                                        <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                            <img src="<?= base_url('public/style');?>/img/preview/shop/top-rated-2.jpg" alt=""/>
                                            <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                        </a>
                                    </div>
                                    <div class="caption text-center">
                                ...
                                <div class="thumbnail no-border no-padding">
                                    <div class="media">
                                        <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                            <img src="<?= base_url('public/style');?>/img/preview/shop/top-rated-3.jpg" alt=""/>
                                            <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                        </a>
                                    </div>
                                    <div class="caption text-center">
                                ...
                                <div class="thumbnail no-border no-padding">
                                    <div class="media">
                                        <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                            <img src="<?= base_url('public/style');?>/img/preview/shop/top-rated-4.jpg" alt=""/>
                                            <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                        </a>
                                    </div>
                                    <div class="caption text-center">
                                ...
                                <div class="thumbnail no-border no-padding">
                                    <div class="media">
                                        <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                            <img src="<?= base_url('public/style');?>/img/preview/shop/top-rated-5.jpg" alt=""/>
                                            <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                        </a>
                                    </div>
                                    <div class="caption text-center">
                                ...
                                <div class="thumbnail no-border no-padding">
                                    <div class="media">
                                        <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style');?>/img/preview/shop/product-1-big.jpg">
                                            <img src="<?= base_url('public/style');?>/img/preview/shop/top-rated-6.jpg" alt=""/>
                                            <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                        </a>
                                    </div>
                                    <div class="caption text-center">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="recent-post">
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/blog/recent-post-1.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                            ...
                            <div class="col-md-6">
                                <div class="recent-post">
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/blog/recent-post-2.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                            ...
                            <div class="col-md-6">
                                <div class="recent-post">
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/blog/recent-post-3.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                            ...
                            <div class="col-md-6">
                                <div class="recent-post">
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/blog/recent-post-4.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                    ...
                    <div class="container">
                        ...
                        <div class="partners-carousel">
                            <div class="owl-carousel" id="partners">
                                <div><a href="#"><img src="<?= base_url('public/style');?>/img/preview/partners/brand-logo.jpg" alt=""/></a></div>
                                <div><a href="#"><img src="<?= base_url('public/style');?>/img/preview/partners/brand-logo.jpg" alt=""/></a></div>
                                <div><a href="#"><img src="<?= base_url('public/style');?>/img/preview/partners/brand-logo.jpg" alt=""/></a></div>
                                <div><a href="#"><img src="<?= base_url('public/style');?>/img/preview/partners/brand-logo.jpg" alt=""/></a></div>
                                <div><a href="#"><img src="<?= base_url('public/style');?>/img/preview/partners/brand-logo.jpg" alt=""/></a></div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="product-list">
                                    ...
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/shop/top-sellers-1.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                            ...
                            <div class="col-md-4">
                                <div class="product-list">
                                    ...
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/shop/top-sellers-4.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                                    ...
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/shop/top-sellers-5.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                                    ...
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/shop/top-sellers-6.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                            ...
                            <div class="col-md-4">
                                <div class="product-list">
                                    ...
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/shop/top-sellers-7.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                                    ...
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/shop/top-sellers-8.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                                    ...
                                    <div class="media">
                                        <a class="pull-right media-link" href="#">
                                            <img class="media-object" src="<?= base_url('public/style');?>/img/preview/shop/top-sellers-9.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="payments">
                                    <ul>
                                        <li><img src="<?= base_url('public/style');?>/img/preview/payments/visa.jpg" alt=""/></li>
                                        <li><img src="<?= base_url('public/style');?>/img/preview/payments/mastercard.jpg" alt=""/></li>
                                        <li><img src="<?= base_url('public/style');?>/img/preview/payments/paypal.jpg" alt=""/></li>
                                        <li><img src="<?= base_url('public/style');?>/img/preview/payments/american-express.jpg" alt=""/></li>
                                        <li><img src="<?= base_url('public/style');?>/img/preview/payments/visa-electron.jpg" alt=""/></li>
                                        <li><img src="<?= base_url('public/style');?>/img/preview/payments/maestro.jpg" alt=""/></li>
                                    </ul>
                                </div>
                            </div>
        ...
        <!-- JS Global -->
        <script src="<?= base_url('public/style');?>/plugins/jquery/jquery-1.11.1.min.js"></script>
        <script src="<?= base_url('public/style');?>/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?= base_url('public/style');?>/plugins/bootstrap-select/js/bootstrap-select.min.js"></script>
        <script src="<?= base_url('public/style');?>/plugins/superfish/js/superfish.min.js"></script>
        <script src="<?= base_url('public/style');?>/plugins/prettyphoto/js/jquery.prettyPhoto.js"></script>
        <script src="<?= base_url('public/style');?>/plugins/owl-carousel2/owl.carousel.min.js"></script>
        <script src="<?= base_url('public/style');?>/plugins/jquery.sticky.min.js"></script>
        <script src="<?= base_url('public/style');?>/plugins/jquery.easing.min.js"></script>
        <script src="<?= base_url('public/style');?>/plugins/jquery.smoothscroll.min.js"></script>
        <script src="<?= base_url('public/style');?>/plugins/smooth-scrollbar.min.js"></script>

        <!-- JS Page Level -->
        <script src="<?= base_url('public/style');?>/js/theme.js"></script>

        <!--[if (gte IE 9)|!(IE)]><!-->
        <script src="<?= base_url('public/style');?>/plugins/jquery.cookie.js"></script>
        <script src="<?= base_url('public/style');?>/js/theme-config.js"></script>
        <!--<![endif]-->
