            ...
            <div class="row">
                    ...
                    <div class="thumbnail no-border no-padding thumbnail-banner size-1x3">
                        <div class="media">
                            <a class="media-link" href="#">
                                <div class="img-bg" style="background-image: url('<?= base_url('public/style'); ?>/img/banner-1.jpg')"></div>
                                <div class="caption">
                ...
                <div class="col-md-6">
                    <div class="thumbnail no-border no-padding thumbnail-banner size-1x3">
                        <div class="media">
                            <a class="media-link" href="#">
                                <div class="img-bg" style="background-image: url('<?= base_url('public/style'); ?>/img/banner-2.jpg')"></div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="thumbnail no-border no-padding">
                                <div class="media">
                                    <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                        <img src="<?= base_url('public/style'); ?>/img/product-3.jpg" alt=""/>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="thumbnail no-border no-padding">
                                <div class="media">
                                    <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                        <img src="<?= base_url('public/style'); ?>/img/product-4.jpg" alt=""/>
                                        <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                    </a>
                                </div>
                                <div class="caption text-center">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="thumbnail no-border no-padding">
                                <div class="media">
                                    <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                        <img src="<?= base_url('public/style'); ?>/img/product-1.jpg" alt=""/>
                                        <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                    </a>
                                </div>
                                <div class="caption text-center">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="thumbnail no-border no-padding">
                                <div class="media">
                                    <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                        <img src="<?= base_url('public/style'); ?>/img/product-2.jpg" alt=""/>
                                        <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                    </a>
                                </div>
                                <div class="caption text-center">
            ...
            <div class="top-products-carousel">
                <div class="owl-carousel" id="top-products-carousel">
                    <div class="thumbnail no-border no-padding">
                        <div class="media">
                            <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                <img src="<?= base_url('public/style'); ?>/img/top-rated-1.jpg" alt=""/>
                                <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                            </a>
                        </div>
                        <div class="caption text-center">
                    ...
                    <div class="thumbnail no-border no-padding">
                        <div class="media">
                            <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                <img src="<?= base_url('public/style'); ?>/img/top-rated-2.jpg" alt=""/>
                                <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                            </a>
                        </div>
                        <div class="caption text-center">
                    ...
                    <div class="thumbnail no-border no-padding">
                        <div class="media">
                            <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                <img src="<?= base_url('public/style'); ?>/img/top-rated-3.jpg" alt=""/>
                                <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                            </a>
                        </div>
                        <div class="caption text-center">
                    ...
                    <div class="thumbnail no-border no-padding">
                        <div class="media">
                            <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                <img src="<?= base_url('public/style'); ?>/img/top-rated-4.jpg" alt=""/>
                                <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                            </a>
                        </div>
                        <div class="caption text-center">
                    ...
                    <div class="thumbnail no-border no-padding">
                        <div class="media">
                            <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                <img src="<?= base_url('public/style'); ?>/img/top-rated-5.jpg" alt=""/>
                                <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                            </a>
                        </div>
                        <div class="caption text-center">
                    ...
                    <div class="thumbnail no-border no-padding">
                        <div class="media">
                            <a class="media-link" data-gal="prettyPhoto" href="<?= base_url('public/style'); ?>/img/product-1-big.jpg">
                                <img src="<?= base_url('public/style'); ?>/img/top-rated-6.jpg" alt=""/>
                                <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                            </a>
                        </div>
                        <div class="caption text-center">
            ...
            <div class="row">
                    ...
                    <div class="recent-post">
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/recent-post-1.jpg" alt="">
                ...
                <div class="col-md-6">
                    <div class="recent-post">
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/recent-post-2.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                ...
                <div class="col-md-6">
                    <div class="recent-post">
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/recent-post-3.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                ...
                <div class="col-md-6">
                    <div class="recent-post">
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/recent-post-4.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
        ...
        <div class="container">
            ...
            <div class="partners-carousel">
                <div class="owl-carousel" id="partners">
                    <div><a href="#"><img src="<?= base_url('public/style'); ?>/img/brand-logo.jpg" alt=""/></a></div>
                    <div><a href="#"><img src="<?= base_url('public/style'); ?>/img/brand-logo.jpg" alt=""/></a></div>
                    <div><a href="#"><img src="<?= base_url('public/style'); ?>/img/brand-logo.jpg" alt=""/></a></div>
                    <div><a href="#"><img src="<?= base_url('public/style'); ?>/img/brand-logo.jpg" alt=""/></a></div>
                    <div><a href="#"><img src="<?= base_url('public/style'); ?>/img/brand-logo.jpg" alt=""/></a></div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="product-list">
                        ...
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/top-sellers-1.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/top-sellers-2.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                        ...
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/top-sellers-3.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                ...
                <div class="col-md-4">
                    <div class="product-list">
                        ...
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/top-sellers-4.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                        ...
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/top-sellers-5.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                        ...
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/top-sellers-6.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                ...
                <div class="col-md-4">
                    <div class="product-list">
                        ...
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/top-sellers-7.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                        ...
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/top-sellers-8.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
                        ...
                        <div class="media">
                            <a class="pull-left media-link" href="#">
                                <img class="media-object" src="<?= base_url('public/style'); ?>/img/top-sellers-9.jpg" alt="">
                                    <i class="fa fa-plus"></i>
                            </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
